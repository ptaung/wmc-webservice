...
use app\modules\silasoft\components\CadminManager;
    ...
    'columns' => [
        [
            ...
            'value' => function ($model) {
                return $model->profile->name . '<br><small>' . app\modules\webclient\components\Cwebclient::getHoscode($model->profile->hospcode) . '</small>';
            },
            'format' => 'raw',
        ],
        [
            'label' => 'สิทธิการใช้งาน',
            #'attribute' => 'profile.hospcode',
            'value' => function ($model) {
        ...
        [
            ...
            'value' => function ($model) {
                ...
                [
                    'header' => Yii::t('user', 'ยื่นยันการใช้งาน'),
                    'value' => function ($model) {
                        ...
                        [
                            'header' => Yii::t('user', 'ยื่นยันสิทธิใช้งาน'),
                            'value' => function ($model) {
