...
<div class="ph-step-ebiedding-form">
    ...
    switch ($step) {
        case 1:
            echo $form->field($model, 'step_1')->textInput();
            break;
        case 2:
            echo $form->field($model, 'step_21')->widget(DatePicker::classname(), [
            ...
            echo $form->field($model, 'step_22')->widget(DatePicker::classname(), [
                'options' => ['placeholder' => 'วันที่ ...'],
                'type' => DatePicker::TYPE_COMPONENT_APPEND,
                'language' => 'th',
                'pluginOptions' => [
        ...
        case 3:
            ...
            break;
        case 4:
            echo $form->field($model, 'step_41')->widget(DatePicker::classname(), [
                'options' => ['placeholder' => 'วันที่ ...'],
                'type' => DatePicker::TYPE_COMPONENT_APPEND,
                'language' => 'th',
                'pluginOptions' => [
            ...
            echo $form->field($model, 'step_43')->textInput();
            break;
        case 5:
            echo $form->field($model, 'step_51')->widget(DatePicker::classname(), [
                'options' => ['placeholder' => 'วันที่ ...'],
                'type' => DatePicker::TYPE_COMPONENT_APPEND,
                'language' => 'th',
                'pluginOptions' => [
            ...
            echo $form->field($model, 'step_52')->textInput();
            break;
        default:
            break;
    }
