...
use app\modules\silasoft\models\ExtUser;
...
#'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset Grid', ['index'], ['class' => 'btn btn-info']),
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($data) {
            return Html::a($data['menu_items_name'], ['update', 'id' => $data['menu_items_id']]) . '<br><small>ที่มา::' . $data['menu_items_comment'] . '</small>';
        }
            ],
            [
            ...
            [
                ...
                #'filter' => Html::activeDropDownList($searchModel, 'menu_items_user_create', ArrayHelper::map(ExtUser::find()->all(), 'id', 'profile.name'), ['class' => 'form-control', 'prompt' => '<< เลือก >>']),
            ...
            [
                ...
                #'filter' => Html::activeDropDownList($searchModel, 'menu_items_user_update', ArrayHelper::map(ExtUser::find()->all(), 'id', 'profile.name'), ['class' => 'form-control', 'prompt' => '<< เลือก >>']),
