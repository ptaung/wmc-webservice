...
class MenuItems extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['menu_items_comment', 'menu_group_id'], 'required'],
    ...
    public function attributeLabels() {
        return [
            ...
            'menu_items_param' => Yii::t('app', 'Chart Data'),
    ...
    public function afterFind() {
        ...
        $this->menu_items_param = base64_decode($this->menu_items_param);
    }
    ...
    public function getUserCreate() {
        return $this->hasOne(ExtUser::className(), ['id' => 'menu_items_user_create']);
    }

    public function getUserUpdate() {
        return $this->hasOne(ExtUser::className(), ['id' => 'menu_items_user_update']);
    }
    ...
    public function beforeSave($insert) {
        ...
        $this->menu_items_param = base64_encode($this->menu_items_param);
