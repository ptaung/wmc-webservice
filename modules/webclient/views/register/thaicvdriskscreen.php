...
$this->title = 'รายชื่อคัดกรองเบาหวานความดัน ประเมินความเสี่ยงตาม THAI CVD-RISK';
...
<div class="menu-group-index">
  ...
  <div class="form-group">
    ' . Html::dropDownList('q_ampurcode', (isset($_GET['q_ampurcode']) ? $_GET['q_ampurcode'] : $_GET['q_ampurcode']), \yii\helpers\ArrayHelper::map($dataCampur, 'ampurcodefull', 'ampurname'), ['class' => 'form-control input-sm', 'prompt' => ' ++เลือกอำเภอ++']) . '
