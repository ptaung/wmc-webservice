        ...
        <div class="col-md-3">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">ประชากรจำแนกตาม Typearea</h3>
                        </div>
                        <?php
                        echo Highcharts::widget([
                            'scripts' => [
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">สถานะการส่งข้อมูลล่าช้า(Sync)ตารางที่ใช้บ่อย</h3>
                        </div>
                        <?php
                        echo Highcharts::widget([
                            'scripts' => [
                            ...
                            'options' => [
                                ...
                                'plotOptions' => [
                                    'series' => [
                                        'dataLabels' => ['enabled' => true, 'format' => '{point.y:.1f} วัน', 'borderWidth' => 0,],
                                    ],
                                ],
                ...
                <div class="col-md-12 hidden">
                    <div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">สรุปผลงานตัวชี้วัดตาม HDC</h3>
                                </div>
                                ...
                                echo Highcharts::widget([
                                    ...
                                    'options' => [
                                        ...
                                        'colors' => ['#f45b5b', '#91e8e1', '#8085e9', '#1d599d', '#7cb5ec', '#90ed7d', '#f15c80', '#e4d354', '#2b908f', '#f45b5b'],
                                        'title' => ['text' => ''],
                                        'xAxis' => [
                                            'type' => 'category'
                                        ],
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ร้อยละของผู้ป่วย DM, HT ที่ได้รับการค้นหาและคัดกรองโรคไตเรื้อรัง</h3>
                                </div>
                                ...
                                echo Highcharts::widget([
                                    ...
                                    'options' => [
                                        ...
                                        'credits' => ['enabled' => false],
                                        'series' => Cdata::getDmhtCkdScreen('asc')
                                    ]
                                ]);
                                ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ผลงานเบาหวาน ได้รับตรวจจอประสาทตา</h3>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ผลงาน KPI ผู้ป่วยโรคเบาหวานที่ควบคุมระดับน้ำตาลได้ดี</h3>
                                </div>
                                <?php
                                echo Highcharts::widget([
                                    'scripts' => [
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ผลงาน KPI พัฒนาการเด็ก 18,30 เดือน ได้รับการตรวจพัฒนาการ</h3>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ผลงาน KPI หญิงตั้งครรภ์ที่ได้รับการดูแลก่อนคลอด 5 ครั้ง ตามเกณฑ์</h3>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ผลงาน KPI หญิงตั้งครรภ์ได้รับการฝากครรภ์ครั้งแรกก่อนหรือเท่ากับ 12 สัปดาห์</h3>
                                </div>
