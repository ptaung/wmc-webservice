...
$this->title = 'รายชื่อเป้าหมายความครอบคลุมของเด็กอายุครบ 2 ปี ' . (isset($_GET['q_byear']) ? 'ช่วงเด็กเกิดวันที่ ' . Cwebclient::getThaiDate($birth[0]) . ' ถึง ' . Cwebclient::getThaiDate($birth[1]) : '');
...
#current budgetyear
    ...
    <?php
    $url = yii\helpers\Url::to(['target/epi2detail']);
    $this->registerJs(
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <i class="fa fa-fw fa-heartbeat" style="color: #1E8000;"></i> <b>ผลงานการเก็บความครอบคลุมของเด็กอายุครบ 2 ปีที่ได้รับวัคซีน DTP4,โปลิโอ4,JE</b>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">DTP4</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['dtp4']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                        <span style="font-size: 14px;"><?= @number_format((($target['dtp4'] * 100) / $target['target']), 2) ?>%</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">โปลิโอ4</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['opv4']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                    </span>
                                    <span style="font-size: 14px;"><?= @number_format((($target['opv4'] * 100) / $target['target']), 2) ?>%</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">JE1</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['je1']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                    </span>
                                    <span style="font-size: 14px;"><?= @number_format((($target['je1'] * 100) / $target['target']), 2) ?>%</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">JE2</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['je2']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                    </span>
                                    <span style="font-size: 14px;"><?= @number_format((($target['je2'] * 100) / $target['target']), 2) ?>%</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">J11</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['j11']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                    </span>
                                    <span style="font-size: 14px;"><?= @number_format((($target['j11'] * 100) / $target['target']), 2) ?>%</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            [
                ...
                'value' => function($data, $key, $index, $column) {
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function($data) {
                            return ($data['dtp4_date'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['dtp4_date']) . '</small>' : '');
                        }
                    ],
                    [
                        'label' => 'โปลิโอ4',
                        ...
                        'format' => 'raw',
                        'value' => function($data) {
                            return ($data['opv4_date'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['opv4_date']) . '</small>' : '');
                        }
                    ],
                    [
                        'label' => 'JE1',
