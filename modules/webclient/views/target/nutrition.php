...
$this->title = 'รายชื่อเป้าหมายเด็กวัยเรียน สูงดีสมส่วน อายุ 6 – 14 ปี ' . (isset($_GET['q_byear']) ? 'ช่วงคัดกรองวันที่ ' . Cwebclient::getThaiDate($birth[0]) . ' ถึง ' . Cwebclient::getThaiDate($birth[1]) : '');
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <i class="fa fa-fw fa-heartbeat" style="color: #1E8000;"></i> <b>ผลงานเด็กวัยเรียน สูงดีสมส่วน อายุ 6 – 14 ปี</b>
...
<div class="box-body">
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function($data) {
                    return ($data['dserv1'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['dserv1']) . '</small>' : '');
                }
            ],
            [
                'label' => 'เทอม1 พค. - มิย.',
                ...
                'format' => 'raw',
                'value' => function($data) {
                    return ($data['dserv2'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['dserv2']) . '</small>' : '');
                }
            ],
            [
                'label' => 'หมายเหตุ',
