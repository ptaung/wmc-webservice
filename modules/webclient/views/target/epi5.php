...
$this->title = 'รายชื่อเป้าหมายความครอบคลุมของเด็กอายุครบ 5 ปี ' . (isset($_GET['q_byear']) ? 'ช่วงเด็กเกิดวันที่ ' . Cwebclient::getThaiDate($birth[0]) . ' ถึง ' . Cwebclient::getThaiDate($birth[1]) : '');
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <i class="fa fa-fw fa-heartbeat" style="color: #1E8000;"></i> <b>ผลงานการเก็บความครอบคลุมของเด็กอายุครบ 5 ปีที่ได้รับวัคซีน DTP5,โปลิโอ5</b>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">DTP5</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['dtp5']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                    </span>
                                    <span style="font-size: 14px;"><?= @number_format((($target['dtp5'] * 100) / $target['target']), 2) ?>%</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-box">
                                <span class="info-box-icon info-box-icon bg-teal"><i class="fa fa-fw fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"> <b style="font-size: 18px;">โปลิโอ5</b> <br>
                                        <span style="font-size: 25px;"><b> <?= @number_format($target['opv5']) ?>
                                            </b></span><span style="font-size: 10px;"> คน</span>
                                        <br>
                                        <span style="font-size: 14px;"><?= @number_format((($target['opv5'] * 100) / $target['target']), 2) ?>%</span>
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            [
                ...
                'value' => function($data, $key, $index, $column) {
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function($data) {
                            return ($data['dtp5_date'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['dtp5_date']) . '</small>' : '');
                        }
                    ],
                    [
                        'label' => 'โปลิโอ5',
                        ...
                        'format' => 'raw',
                        'value' => function($data) {
                            return ($data['opv5_date'] <> '' ? '<small>' . Cwebclient::getThaiDate($data['opv5_date']) . '</small>' : '');
                        }
                    ],
                    [
                        'label' => 'หมายเหตุ',
