...
$this->title = 'รายชื่อเป้าหมายคัดกรองมะเร็งเต้านมในสตรีอายุ 30 – 70 ปี ' . (isset($_GET['q_byear']) ? 'ช่วงคัดกรองวันที่ ' . Cwebclient::getThaiDate($birth[0]) . ' ถึง ' . Cwebclient::getThaiDate($birth[1]) : '');
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <i class="fa fa-fw fa-heartbeat" style="color: #1E8000;"></i> <b>ผลงานการคัดกรองมะเร็งเต้านมในสตรีอายุ 30 – 70 ปี</b>
